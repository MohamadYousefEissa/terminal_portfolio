...
onBeforeMount(() => {
  const theme = window.localStorage.getItem('theme') || 'ubutnu'
  setTheme(theme)
  radio.value = theme
})
</script>
...
<template>
  <div class="theme-popup absolute right-6" ref="popup">
    ...
    <input type="radio" name="theme" id="ubutnu" value="ubutnu" v-model="radio" />
...
#ubutnu:checked ~ .theme-popup__list-container label[for='ubutnu'],
...
#ubutnu:checked ~ label svg.ubuntu,
